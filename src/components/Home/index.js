        ...
        <div className="container home-page">
            ...
            <div className="text-zone"> 
                ...
                <h2><GradientText
                    ...
                    <AnimatedLetters letterClass={letterClass} strArray={job2Array} idx={44}/>
                    </GradientText>
                </h2>
                <h2><GradientText
                    colors={["#40ffaa", "#4079ff", "#40ffaa", "#4079ff", "#40ffaa"]}
